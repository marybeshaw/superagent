...
Request.prototype._redirect = function(res){
  ...
  if (changesOrigin) {
    let domainRegex = /(?:[a-zA-Z0-9][a-zA-Z0-9-]*\.)*([a-zA-Z0-9][a-zA-Z0-9-]{1,61}[a-zA-Z0-9]\.[a-zA-Z]{2,}|localhost)(?::\d+)?/g;
    ...
    if (newUrlMatch && newUrlMatch[1] && oldUrlMatch && oldUrlMatch[1]) {
      changesOrigin = Boolean((newUrlMatch[1] !== oldUrlMatch[1]) && (oldUrlMatch[1] !== 'localhost'));
    }
  }
